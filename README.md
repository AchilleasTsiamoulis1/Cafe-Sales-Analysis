...
Finally, all of the above sheets have been arranged uniformly in an interactive dashboard where the other charts change depending on what the user clicks. This sheet is a **pie chart**.
